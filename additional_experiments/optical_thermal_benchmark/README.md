# Additional Experiments — Optical–Thermal Image Restoration Benchmark

**Status: additional exploratory work, outside the assigned task.** This folder preserves the earlier benchmark, synthetic waveform demonstrations, samples, notebook, and results. The assigned project is described in the [main README](../../README.md).

Run commands on this page from this folder. Install dependencies with `python -m pip install -r ../../requirements.txt`. The runners reuse `src/pipeline.py` at the repository root.
...
For the assigned project's formal problem statement, objectives, and methodology, see **[PROJECT_WRITEUP.md](../../PROJECT_WRITEUP.md)**.
...
../../src/pipeline.py              # shared restorers and metrics at repository root
export_real_samples.py             # exports small real-image subset from public archive
run_real_image_enhancement.py      # additional real-image benchmark
